...
const PopupPicker = React.createClass({
  ...
  getModal() {
    ...
    return (<ModalClass className={props.className}
      ...
      <div className={`${props.prefixCls}-pop-header`}>
        <div className={`${props.prefixCls}-pop-item`} onClick={this.onDismiss}>{props.dismissText}</div>
        <div className={`${props.prefixCls}-pop-item`}></div>
        <div className={`${props.prefixCls}-pop-item`} onClick={this.onOk}>{props.okText}</div>
      </div>
